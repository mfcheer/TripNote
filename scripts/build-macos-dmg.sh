...
APP_PATH="src-tauri/target/release/bundle/macos/北向.app"
...
OUTPUT_PATH="$OUTPUT_DIR/北向_${VERSION}_${ARCH}.dmg"
...
mkdir -p "$OUTPUT_DIR"
ditto "$APP_PATH" "$STAGE_DIR/北向.app"
ln -s /Applications "$STAGE_DIR/Applications"
hdiutil create -volname "北向" -srcfolder "$STAGE_DIR" -ov -format UDZO "$OUTPUT_PATH"
