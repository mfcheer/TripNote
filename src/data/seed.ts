...
export const seedTrip: Trip = {
  ...
  activities: [
    ...
    { id: 'a4', dayId: 'd1', time: '21:00', title: '入住 心斋桥民宿', category: 'stay', location: '大阪市中央区', note: '第1-3晚 · 含早餐', costs: [{ id: 'c3', title: '民宿 3晚', amount: 2800 }], geo: { lat: 34.6712, lng: 135.5031 } },
    ...
    { id: 'a8', dayId: 'd2', time: '16:00', title: '梅田蓝天大厦 · 空中庭园', category: 'sight', location: '大阪市北区大淀中1-1', costs: [{ id: 'c7', title: '观景台门票', amount: 800 }], duration: '2小时', note: '日落前上楼看夜景', geo: { lat: 34.7052, lng: 135.4902 } },
    ...
    { id: 'a13', dayId: 'd3', time: '19:00', title: '先斗町 晚餐', category: 'food', location: '京都市中京区', costs: [{ id: 'c11', amount: 300 }], geo: { lat: 35.0069, lng: 135.7705 } },
    ...
    { id: 'a17', dayId: 'd4', time: '17:00', title: '岚山 · 渡月桥', category: 'sight', location: '京都市右京区', costs: [], duration: '2小时', geo: { lat: 35.0146, lng: 135.6768 } },
    ...
    { id: 'a19', dayId: 'd5', time: '10:30', title: '奈良公园 · 喂小鹿', category: 'sight', location: '奈良市奈良公园', note: '鹿饼 ¥200/份，注意别被围堵', costs: [{ id: 'c15', title: '鹿饼', amount: 200 }], duration: '2.5小时', geo: { lat: 34.6849, lng: 135.8481 } },
    ...
    { id: 'a21', dayId: 'd5', time: '16:00', title: '返程 · 近铁奈良 → 关西机场', category: 'traffic', location: '近铁奈良站', note: '预留退税和登机时间', costs: [], geo: { lat: 34.6851, lng: 135.8431 } },
  ],
  wishPlaces: [],
  expenses: [],
}
